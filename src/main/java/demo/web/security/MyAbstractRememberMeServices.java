...
public abstract class MyAbstractRememberMeServices implements RememberMeServices, InitializingBean, LogoutHandler {
    ...
    protected MyAbstractRememberMeServices(String key, UserDetailsService userDetailsService) {
