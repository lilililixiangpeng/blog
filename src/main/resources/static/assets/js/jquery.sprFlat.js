    ...
    $.sprFlat = function(element, options) {
        ...
        plugin.chatWindow = function() {
            ...
            function appendMsg (msg) {
                ...
                $('.chat-box .chat-messages').append('<li class="chat-me"><p class="avatar"><img src="../getimgs"></p><p class="chat-name">'+ username +' <span class="chat-time">'+ time +'</span></p><span class="status online"><i class="en-dot"></i></span><p class="chat-txt">'+ msg +'</p></li>');
            }
        }
